...
3. `roles/test-e2e-playwright/tasks/03_run_pass.yml` forwards the resolved value into the Playwright container as `-e INFINITO_PLAYWRIGHT_KEEP={{ test_e2e_playwright_keep }}`.
